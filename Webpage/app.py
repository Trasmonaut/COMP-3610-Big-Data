...
def warning_check(prediction_dict):
    ...
    if precip > 200:
        ...
        warnings.append("Heavy Flooding possible")
    elif precip > 50:
        warnings.append("Light Flooding possible")
...
def predict():
    ...
    return render_template('result.html', location=location, date=date_str, warnings = warnings,
